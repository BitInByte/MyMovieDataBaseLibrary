...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // Simple movie async query fetch\n\n// Imports =====================================================\n\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n// class MOVIE =====================================================\nvar Movie = function () {\n\n    // Constructor =====================================================\n    function Movie(id) {\n        _classCallCheck(this, Movie);\n\n        this.id = id;\n    }\n\n    // Async function fetching an API =====================================================\n\n\n    _createClass(Movie, [{\n        key: \"getMovie\",\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var proxy, key, result;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n\n                                // Get proxy and key from an .env file\n                                proxy = \"https://cors-anywhere.herokuapp.com/\";\n                                key = \"460a78c7\";\n\n                                // Error handler\n\n                                _context.prev = 2;\n                                _context.next = 5;\n                                return (0, _axios2.default)(proxy + \"http://www.omdbapi.com/?apikey=\" + key + \"&i=\" + this.id + \"&plot=full\");\n\n                            case 5:\n                                result = _context.sent;\n\n\n                                // Storing results to the object\n                                this.title = result.data.Title;\n                                this.year = result.data.Year;\n                                this.runtime = result.data.Runtime;\n                                this.released = result.data.Released;\n                                this.director = result.data.Director;\n                                this.rating = result.data.imdbRating;\n                                this.img = result.data.Poster;\n                                this.imdbId = result.data.imdbID;\n                                this.imdbWebSite = \"https://www.imdb.com/title/\" + this.imdbId;\n                                this.description = result.data.Plot;\n\n                                _context.next = 22;\n                                break;\n\n                            case 18:\n                                _context.prev = 18;\n                                _context.t0 = _context[\"catch\"](2);\n\n                                alert(_context.t0);\n                                console.log(_context.t0);\n\n                            case 22:\n                            case \"end\":\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[2, 18]]);\n            }));\n\n            function getMovie() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getMovie;\n        }()\n    }]);\n\n    return Movie;\n}();\n\nexports.default = Movie;\n\n//# sourceURL=webpack:///./src/js/modules/Movie.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.cleanResultsContainer = exports.cleanResults = exports.renderResults = exports.convertTime = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\n/*\n* WATCHED VIEW CONTROLS\n*/\n\n// ===== private methods =====\n\n// Render the markup to render the title\nvar renderTitle = function renderTitle(uptime, time) {\n\n    if (time === 0) {\n        var markup = '\\n            <h2>You didn\\'t watched movies yet!</h2>\\n        ';\n\n        _base.elements.watchedMovieTitle.insertAdjacentHTML('afterbegin', markup);\n    } else {\n        var _markup = '\\n            <h2>You have watched ' + uptime[0] + ' day/s, ' + uptime[1] + ' hour/s and ' + uptime[2] + ' minutes!</h2>\\n        ';\n\n        _base.elements.watchedMovieTitle.insertAdjacentHTML('afterbegin', _markup);\n    }\n};\n\n// Render the markup to render the movies\n// Watched view\n\n// Imports =====================================================\nvar renderMarkup = function renderMarkup(id, img, title) {\n\n    if (img === \"N/A\") {\n\n        var markup = '\\n        <a href=\"#\" class=\"watched-panel-link\" data-id=' + id + '>\\n            <div class=\"watched-panel--movie-container\">\\n                <div class=\"watched-panel--movie\">\\n                    \\n                        <div class=\"watched-panel-movie-img\">\\n                            <img src=\"' + img + '\" alt=\"N/A\">\\n                        </div>\\n                        <div class=\"watched-panel-movie-title\">\\n                            <p>' + title + '</p>\\n                        </div>\\n                    \\n                </div>    \\n            </div>\\n        </a>\\n        ';\n\n        _base.elements.watchedMovieContainer.insertAdjacentHTML('afterbegin', markup);\n    } else {\n        var _markup2 = '\\n        <a href=\"#\" class=\"watched-panel-link\" data-id=' + id + '>\\n            <div class=\"watched-panel--movie-container\">\\n                <div class=\"watched-panel--movie\">\\n                    \\n                        <div class=\"watched-panel-movie-img\">\\n                            <img src=\"' + img + '\" alt=\"' + title + '\">\\n                        </div>\\n                        <div class=\"watched-panel-movie-title\">\\n                            <p>' + title + '</p>\\n                        </div>\\n                    \\n                </div>    \\n            </div>\\n        </a>\\n        ';\n\n        _base.elements.watchedMovieContainer.insertAdjacentHTML('afterbegin', _markup2);\n    }\n};\n\n// ===== Public methods =====\n// DOM MANIPULATIONS =====================================================\n\n// Function to divide the minutes into days, hours and minutes\nvar convertTime = exports.convertTime = function convertTime(uptime) {\n\n    // Divide the minutes into hours\n    var time = String(uptime / 60).split(\".\");\n\n    // Convert the last array from string to int\n    var arrTime = time.map(function (e) {\n        return parseInt(e);\n    });\n\n    // Add the day to the array\n    arrTime.unshift(0);\n\n    // If the minutes is more than 24 then add 1 more day and decrease 24 hours\n    if (arrTime[1] >= 24) {\n        arrTime[0] += 1;\n        arrTime[1] -= 24;\n    }\n\n    // Convert the minutes percentage into time again    \n    arrTime[2] = arrTime[2] / 100 * 60;\n\n    // Remove the weird js bug of the decimal cases\n    var len = (\"\" + arrTime[2]).split(\"\").length;\n    var total = \"0\".repeat(len - 2);\n    var reduce = \"1\" + total;\n    if (len > 2) {\n        arrTime[2] = Math.floor(arrTime[2] / parseInt(reduce).toFixed(0));\n    }\n\n    // Return the array\n    return arrTime;\n};\n\n// Render the resuts\nvar renderResults = exports.renderResults = function renderResults(data) {\n\n    // Clean title and container\n    cleanResults();\n\n    // Render Title\n    renderTitle(convertTime(data.totalTimeWatched), data.totalTimeWatched);\n\n    // Render the movies\n    data.movies.slice().reverse().forEach(function (e) {\n        renderMarkup(e.imdbId, e.img, e.title);\n    });\n};\n\n// Clean the DOM\nvar cleanResults = exports.cleanResults = function cleanResults() {\n\n    // Clean title\n    _base.elements.watchedMovieTitle.innerHTML = \"\";\n\n    // Clean movie container\n    _base.elements.watchedMovieContainer.innerHTML = \"\";\n};\n\n// Clean the section DOM\nvar cleanResultsContainer = exports.cleanResultsContainer = function cleanResultsContainer() {\n    return _base.elements.section.innerHTML = \"\";\n};\n\n//# sourceURL=webpack:///./src/js/views/watchedView.js?");
